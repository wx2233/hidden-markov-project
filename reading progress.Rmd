...
45 participants. The TLFB daily usage for the 12 weeks prior to and 4 weeks after completion of the 2-day stress and cue-reactivity study.

- Objective

Whether study participation alters drug seeking behavior. 
...
```{r, echo=FALSE,warning= FALSE, message = FALSE, echo=FALSE,out.width='50%',fig.pos='h', fig.align = "center"}
